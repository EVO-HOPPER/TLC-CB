...
print '!Thanks Again For The Given Space && Time Legacy.Bounce';                                     \    <=  0; 1; #*# ===***A
print {                                                                                                \  <=  0; 1; #*# ===***B
sub console_CTRL_command_AVES {...}; #*#                                                               /  <=  0; 1; #*# ===***C
sub console_CTRL_command_LOGY {...}; #*# #*#                                                          /   <=  0; 1; #*# ===***D
sub console_CTRL_command_AVES {...}; #*# #*# #*#                                                     /    <=  0; 1; #*# ===***E
...
END;#*# !== important require \@syscall !==require import open service && support 0; 1; %==open{+}@sys     (a)>:|:<(a)
```
